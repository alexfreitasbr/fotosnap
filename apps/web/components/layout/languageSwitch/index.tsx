...
export function LanguageSwitcher() {
  ...
  return (
    <ul className="absolute top-4.5 right-6 flex flex-col h-[22px] overflow-hidden items-center cursor-pointer px-2  hover:h-[150px] hover:bg-black transition-all duration-500 z-20" role="menu" aria-labelledby="language-switch" test-id="language-switch">
